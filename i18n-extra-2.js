...
(function() {
  ...
  const EXTRAS_2 = {
    en: {
      ...
      "arch.svg.edge.sub1": "cache · retry queue",
      "arch.svg.edge.sub2": "weak-signal handling",
      "arch.svg.agent": "Agent core",
      "arch.svg.agent.sub1": "planner · orchestrator",
      "arch.svg.agent.sub2": "error recovery",
    ...
    id: {
      ...
      "arch.svg.channel.sub": "WhatsApp · Telegram",
      "arch.svg.edge": "Edge runtime",
      "arch.svg.edge.sub1": "cache · antrian retry",
      "arch.svg.edge.sub2": "sinyal lemah",
    ...
    cn: {
      ...
      "arch.svg.channel.sub": "WhatsApp · Telegram",
      "arch.svg.edge": "边缘运行时",
      "arch.svg.edge.sub1": "缓存 · 重试队列",
      "arch.svg.edge.sub2": "弱信号处理",
      "arch.svg.agent": "智能体核心",
      "arch.svg.agent.sub1": "规划器 · 编排器",
      "arch.svg.agent.sub2": "错误恢复",
